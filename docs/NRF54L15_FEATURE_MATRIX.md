...
| [x] | Dynamic 16-bit custom GATT | Implemented, including long reads and contiguous queued prepare/execute writes for bounded custom characteristic values. | 128-bit dynamic service editing/descriptors/multi-service mutation remain open. |
