 ...
 *
 * The numeric and string values come from CoreVersionGenerated.h, which is
 * updated as part of the release packaging flow. That keeps the sketch-visible
 * version in sync with the board package version without requiring a build-time
 * generator on the user's machine.
 */
...
#error "CoreVersionGenerated.h was not force-included by the platform"
#endif
