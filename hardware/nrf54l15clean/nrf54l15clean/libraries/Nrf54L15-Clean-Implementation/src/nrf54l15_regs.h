...
// SPIM, SPIS, and TWIM/UARTE share serial fabric instances on this SoC family.
...
constexpr uint32_t CRACEN_BASE = 0x50048000UL;
constexpr uint32_t CRACENCORE_BASE = 0x51800000UL;
constexpr uint32_t SPIS00_BASE = 0x4004A000UL;
constexpr uint32_t SPIM00_BASE = 0x4004A000UL;
constexpr uint32_t SPIS20_BASE = 0x400C6000UL;
constexpr uint32_t QDEC20_BASE = 0x400E0000UL;
constexpr uint32_t QDEC21_BASE = 0x400E1000UL;
constexpr uint32_t SPIS21_BASE = 0x400C7000UL;
constexpr uint32_t TWIM22_BASE = 0x400C8000UL;
constexpr uint32_t TWIM30_BASE = 0x40104000UL;
constexpr uint32_t TIMER10_BASE = 0x40085000UL;
