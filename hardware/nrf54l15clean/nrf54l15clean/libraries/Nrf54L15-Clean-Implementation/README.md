...
- `Pwm`: PWM wrapper for `1..4` channels on one hardware instance, with shared frequency plus per-channel duty/polarity control and raw decoder/sequence playback for grouped or stepped waveforms.
