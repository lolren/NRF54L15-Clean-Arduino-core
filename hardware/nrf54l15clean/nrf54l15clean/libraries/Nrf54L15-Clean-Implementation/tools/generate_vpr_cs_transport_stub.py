...
def main() -> int:
    ...
    firmware_c = tools_root / "vpr_cs_transport_stub.c"
    firmware_ld = tools_root / "vpr_cs_transport_stub.ld"
    out_header = src_root / "vpr_cs_transport_stub_firmware.h"

    with tempfile.TemporaryDirectory() as tmp:
      tmpdir = pathlib.Path(tmp)
      elf = tmpdir / "vpr_cs_transport_stub.elf"
      binary = tmpdir / "vpr_cs_transport_stub.bin"
    ...
    lines = [
        ...
        f"constexpr size_t kVprCsTransportStubFirmwareSize = {len(blob)}U;",
